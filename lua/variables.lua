...
M_BRAIN_ADDON_TENTACLE_DMG		=	2
M_BRAIN_MAX_TENTACLE_DMG		=	0
M_GRENADELAUNCHER_DMG_BASE		=	20
M_GRENADELAUNCHER_DMG_ADDON		=	1.5
...
M_ROCKETLAUNCHER_DMG_BASE		=	35
M_ROCKETLAUNCHER_DMG_ADDON		=	7
