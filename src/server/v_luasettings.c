...
#pragma endregion /*Weapons Parameters*/
	...
	M_JANITOR_INITIAL_HEALTH = vrx_lua_get_variable("M_JANITOR_INITIAL_HEALTH", 1200);
	M_JANITOR_ADDON_HEALTH = vrx_lua_get_variable("M_JANITOR_ADDON_HEALTH", 450);
	M_JANITOR_INITIAL_ARMOR = vrx_lua_get_variable("M_JANITOR_INITIAL_ARMOR", 500);
	M_JANITOR_ADDON_ARMOR = vrx_lua_get_variable("M_JANITOR_ADDON_ARMOR", 150);
