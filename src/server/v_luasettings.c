...
double MAGMINE_IDLE_CELLS;
double MAGMINE_ACTIVE_CELLS;
double MAGMINE_INITIAL_AMMO;
double MAGMINE_ADDON_AMMO;
...
double LIFE_TAP_INITIAL_RANGE;
double LIFE_TAP_ADDON_RANGE;
double LIFE_TAP_INITIAL_RADIUS;
double LIFE_TAP_ADDON_RADIUS;
double LIFE_TAP_INITIAL_DURATION;
double LIFE_TAP_ADDON_DURATION;
double LIFE_TAP_COST;
double LIFE_TAP_DELAY;
double LIFE_TAP_INITIAL_FACTOR;
double LIFE_TAP_ADDON_FACTOR;
...
double M_BERSERKER_INITIAL_HEALTH;
double M_BERSERKER_ADDON_HEALTH;
double M_BERSERKER_INITIAL_ARMOR;
double M_BERSERKER_ADDON_ARMOR;
double M_CHICK_INITIAL_HEALTH;
double M_CHICK_ADDON_HEALTH;
double M_CHICK_INITIAL_ARMOR;
double M_CHICK_ADDON_ARMOR;
double M_BRAIN_INITIAL_HEALTH;
double M_BRAIN_ADDON_HEALTH;
double M_BRAIN_INITIAL_ARMOR;
double M_BRAIN_ADDON_ARMOR;
double M_FLOATER_INITIAL_HEALTH;
double M_FLOATER_ADDON_HEALTH;
double M_FLOATER_INITIAL_ARMOR;
double M_FLOATER_ADDON_ARMOR;
double M_FLYER_INITIAL_HEALTH;
double M_FLYER_ADDON_HEALTH;
double M_FLYER_INITIAL_ARMOR;
double M_FLYER_ADDON_ARMOR;
double M_GLADIATOR_INITIAL_HEALTH;
double M_GLADIATOR_ADDON_HEALTH;
double M_GLADIATOR_INITIAL_ARMOR;
double M_GLADIATOR_ADDON_ARMOR;
double M_GUNNER_INITIAL_HEALTH;
double M_GUNNER_ADDON_HEALTH;
double M_GUNNER_INITIAL_ARMOR;
double M_GUNNER_ADDON_ARMOR;
double M_HOVER_INITIAL_HEALTH;
double M_HOVER_ADDON_HEALTH;
double M_HOVER_INITIAL_ARMOR;
double M_HOVER_ADDON_ARMOR;
double M_MEDIC_INITIAL_HEALTH;
double M_MEDIC_ADDON_HEALTH;
double M_MEDIC_INITIAL_ARMOR;
double M_MEDIC_ADDON_ARMOR;
double M_MUTANT_INITIAL_HEALTH;
double M_MUTANT_ADDON_HEALTH;
double M_MUTANT_INITIAL_ARMOR;
double M_MUTANT_ADDON_ARMOR;
double M_PARASITE_INITIAL_HEALTH;
double M_PARASITE_ADDON_HEALTH;
double M_PARASITE_INITIAL_ARMOR;
double M_PARASITE_ADDON_ARMOR;
double M_TANK_INITIAL_HEALTH;
...
double M_SHAMBLER_INITIAL_HEALTH;
double M_SHAMBLER_ADDON_HEALTH;

// --Monster Weapons --
//double M_SHAMBLER_LIGHTNING_MAX_DMG;
//double M_SHAMBLER_LIGHTNING_BASE_DMG;
//double M_SHAMBLER_ADDON_LIGHTNING_DMG;
double M_BRAIN_INITIAL_PULL;
double M_BRAIN_ADDON_PULL;
double M_BRAIN_MAX_PULL;
double M_BRAIN_INITIAL_TENTACLE_DMG;
double M_BRAIN_ADDON_TENTACLE_DMG;
double M_BRAIN_MAX_TENTACLE_DMG;
double M_ENABLE_WORLDSPAWN_SOFTCAP;
double M_GRENADELAUNCHER_DMG_BASE;
double M_GRENADELAUNCHER_DMG_ADDON;
double M_GRENADELAUNCHER_DMG_MAX;
double M_GRENADELAUNCHER_SPEED_BASE;
double M_GRENADELAUNCHER_SPEED_ADDON;
double M_GRENADELAUNCHER_SPEED_MAX;
double M_ROCKETLAUNCHER_DMG_BASE;
double M_ROCKETLAUNCHER_DMG_ADDON;
double M_ROCKETLAUNCHER_DMG_MAX;
double M_ROCKETLAUNCHER_SPEED_BASE;
double M_ROCKETLAUNCHER_SPEED_ADDON;
double M_ROCKETLAUNCHER_SPEED_MAX;
double M_SHOTGUN_DMG_BASE;
double M_SHOTGUN_DMG_ADDON;
double M_SHOTGUN_DMG_MAX;
double M_RAILGUN_DMG_BASE;
double M_RAILGUN_DMG_ADDON;
double M_RAILGUN_DMG_MAX;
...
double M_MACHINEGUN_DMG_BASE;
double M_MACHINEGUN_DMG_ADDON;
double M_MACHINEGUN_DMG_MAX;
double M_BLASTER_DMG_BASE;
double M_BLASTER_DMG_ADDON;
double M_BLASTER_DMG_MAX;
double M_BLASTER_SPEED_BASE;
double M_BLASTER_SPEED_ADDON;
double M_BLASTER_SPEED_MAX;
double M_20MM_RANGE_BASE;
double M_20MM_RANGE_ADDON;
double M_20MM_RANGE_MAX;
double M_20MM_DMG_BASE;
double M_20MM_DMG_ADDON;
double M_20MM_DMG_MAX;
...
double MEDIC_RESURRECT_BASE;
double MEDIC_RESURRECT_TIMEOUT;
double MEDIC_RESURRECT_INITIAL_TIME;
double MEDIC_RESURRECT_ADDON_TIME;
...
double PARASITE_ATTACK_RANGE;
double PARASITE_INITIAL_KNOCKBACK;
double PARASITE_ADDON_KNOCKBACK;
double PARASITE_MAX_KNOCKBACK;
double PARASITE_INITIAL_DMG;
double PARASITE_ADDON_DMG;
double PARASITE_MAX_DMG;
...
double BLINKSTRIKE_MIN_COST;
double BLINKSTRIKE_DELAY;
double BLINKSTRIKE_FRAMES;
double BLINKSTRIKE_INITIAL_BONUS;
double BLINKSTRIKE_ADDON_BONUS;
double EXPLODING_BARREL_INITIAL_HEALTH;
double EXPLODING_BARREL_ADDON_HEALTH;
double EXPLODING_BARREL_INITIAL_DAMAGE;
double EXPLODING_BARREL_ADDON_DAMAGE;
double EXPLODING_BARREL_COST;
double EXPLODING_BARREL_DELAY;
double EXPLODING_BARREL_MAX_COUNT;
double ACID_GASSER_SYNERGY_BONUS;
double SPIKE_SPIKER_SYNERGY_BONUS;
double FIREWALL_RANGE;
double FIREWALL_INITIAL_DAMAGE;
double FIREWALL_ADDON_DAMAGE;
double FIREWALL_DELAY;
double FIREWALL_DURATION;
double FIREWALL_COST;
double FROZEN_ORB_SPEED;
double FROZEN_ORB_DURATION;
double FROZEN_ORB_DELAY;
double FROZEN_ORB_COST;
double FROZEN_ORB_INITIAL_DAMAGE;
double FROZEN_ORB_ADDON_DAMAGE;
double FROZEN_ORB_INITIAL_CHILL;
double FROZEN_ORB_ADDON_CHILL;
double FROST_NOVA_COST;
double FROST_NOVA_INITIAL_DAMAGE;
double FROST_NOVA_ADDON_DAMAGE;
double FROST_NOVA_INITIAL_RADIUS;
double FROST_NOVA_ADDON_RADIUS;
double FROST_NOVA_DELAY;
double FROST_NOVA_INITIAL_CHILL;
double FROST_NOVA_ADDON_CHILL;
double GLACIAL_SPIKE_COST;
double GLACIAL_SPIKE_INITIAL_CHILL;
double GLACIAL_SPIKE_ADDON_CHILL;
double GLACIAL_SPIKE_INITIAL_FREEZE;
double GLACIAL_SPIKE_ADDON_FREEZE;
double GLACIAL_SPIKE_INITIAL_DAMAGE;
double GLACIAL_SPIKE_ADDON_DAMAGE;
double GLACIAL_SPIKE_INITIAL_RADIUS;
double GLACIAL_SPIKE_ADDON_RADIUS;
double GLACIAL_SPIKE_INITIAL_SPEED;
double GLACIAL_SPIKE_ADDON_SPEED;
double GLACIAL_SPIKE_DELAY;
