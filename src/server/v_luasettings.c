...
#pragma endregion /*Weapons Parameters*/
	...
	MAGMINE_IDLE_CELLS = vrx_lua_get_variable("MAGMINE_IDLE_CELLS", 1);
	MAGMINE_ACTIVE_CELLS = vrx_lua_get_variable("MAGMINE_ACTIVE_CELLS", 10);
	MAGMINE_INITIAL_AMMO = vrx_lua_get_variable("MAGMINE_INITIAL_AMMO", 100);
	MAGMINE_ADDON_AMMO = vrx_lua_get_variable("MAGMINE_ADDON_AMMO", 20);
	...
	CURSE_DEFAULT_INITIAL_RANGE = vrx_lua_get_variable("CURSE_DEFAULT_INITIAL_RANGE", 1024);
	...
	LIFE_TAP_INITIAL_RANGE = vrx_lua_get_variable("LIFE_TAP_INITIAL_RANGE", 1024);
	LIFE_TAP_ADDON_RANGE = vrx_lua_get_variable("LIFE_TAP_ADDON_RANGE", 0);
	LIFE_TAP_INITIAL_RADIUS = vrx_lua_get_variable("LIFE_TAP_INITIAL_RADIUS", 256);
	LIFE_TAP_ADDON_RADIUS = vrx_lua_get_variable("LIFE_TAP_ADDON_RADIUS", 0);
	LIFE_TAP_INITIAL_DURATION = vrx_lua_get_variable("LIFE_TAP_INITIAL_DURATION", 0);
	LIFE_TAP_ADDON_DURATION = vrx_lua_get_variable("LIFE_TAP_ADDON_DURATION", 1.0);
	...
	AMP_DAMAGE_DURATION_BONUS = vrx_lua_get_variable("AMP_DAMAGE_DURATION_BONUS", 1.0);
	AMP_DAMAGE_COST = vrx_lua_get_variable("AMP_DAMAGE_COST", 25);
	AMP_DAMAGE_MULT_BASE = vrx_lua_get_variable("AMP_DAMAGE_MULT_BASE", 1.0);
	AMP_DAMAGE_MULT_BONUS = vrx_lua_get_variable("AMP_DAMAGE_MULT_BONUS", 0.1);

	WEAKEN_DELAY = vrx_lua_get_variable("WEAKEN_DELAY", 1.0);
	...
	WEAKEN_COST = vrx_lua_get_variable("WEAKEN_COST", 25);
	WEAKEN_MULT_BASE = vrx_lua_get_variable("WEAKEN_MULT_BASE", 1.5);
	WEAKEN_MULT_BONUS = vrx_lua_get_variable("WEAKEN_MULT_BONUS", 0.05);
	...
	M_BERSERKER_INITIAL_HEALTH = vrx_lua_get_variable("M_BERSERKER_INITIAL_HEALTH", 120);
	M_BERSERKER_ADDON_HEALTH = vrx_lua_get_variable("M_BERSERKER_ADDON_HEALTH", 75);
	M_BERSERKER_INITIAL_ARMOR = vrx_lua_get_variable("M_BERSERKER_INITIAL_ARMOR", 80);
	M_BERSERKER_ADDON_ARMOR = vrx_lua_get_variable("M_BERSERKER_ADDON_ARMOR", 30);

	M_CHICK_INITIAL_HEALTH = vrx_lua_get_variable("M_CHICK_INITIAL_HEALTH", 50);
	M_CHICK_ADDON_HEALTH = vrx_lua_get_variable("M_CHICK_ADDON_HEALTH", 15);
	M_CHICK_INITIAL_ARMOR = vrx_lua_get_variable("M_CHICK_INITIAL_ARMOR", 25);
	M_CHICK_ADDON_ARMOR = vrx_lua_get_variable("M_CHICK_ADDON_ARMOR", 15);

	M_BRAIN_INITIAL_HEALTH = vrx_lua_get_variable("M_BRAIN_INITIAL_HEALTH", 35);
	M_BRAIN_ADDON_HEALTH = vrx_lua_get_variable("M_BRAIN_ADDON_HEALTH", 45);
	M_BRAIN_INITIAL_ARMOR = vrx_lua_get_variable("M_BRAIN_INITIAL_ARMOR", 150);
	M_BRAIN_ADDON_ARMOR = vrx_lua_get_variable("M_BRAIN_ADDON_ARMOR", 150);

	M_FLOATER_INITIAL_HEALTH = vrx_lua_get_variable("M_FLOATER_INITIAL_HEALTH", 50);
	M_FLOATER_ADDON_HEALTH = vrx_lua_get_variable("M_FLOATER_ADDON_HEALTH", 20);
	M_FLOATER_INITIAL_ARMOR = vrx_lua_get_variable("M_FLOATER_INITIAL_ARMOR", 150);
	M_FLOATER_ADDON_ARMOR = vrx_lua_get_variable("M_FLOATER_ADDON_ARMOR", 60);

	M_FLYER_INITIAL_HEALTH = vrx_lua_get_variable("M_FLYER_INITIAL_HEALTH", 50);
	M_FLYER_ADDON_HEALTH = vrx_lua_get_variable("M_FLYER_ADDON_HEALTH", 20);
	M_FLYER_INITIAL_ARMOR = vrx_lua_get_variable("M_FLYER_INITIAL_ARMOR", 50);
	M_FLYER_ADDON_ARMOR = vrx_lua_get_variable("M_FLYER_ADDON_ARMOR", 20);

	M_GLADIATOR_INITIAL_HEALTH = vrx_lua_get_variable("M_GLADIATOR_INITIAL_HEALTH", 100);
	M_GLADIATOR_ADDON_HEALTH = vrx_lua_get_variable("M_GLADIATOR_ADDON_HEALTH", 10);
	M_GLADIATOR_INITIAL_ARMOR = vrx_lua_get_variable("M_GLADIATOR_INITIAL_ARMOR", 100);
	M_GLADIATOR_ADDON_ARMOR = vrx_lua_get_variable("M_GLADIATOR_ADDON_ARMOR", 20);

	M_GUNNER_INITIAL_HEALTH = vrx_lua_get_variable("M_GUNNER_INITIAL_HEALTH", 50);
	...
	M_HOVER_INITIAL_ARMOR = vrx_lua_get_variable("M_HOVER_INITIAL_ARMOR", 50);
	M_HOVER_ADDON_ARMOR = vrx_lua_get_variable("M_HOVER_ADDON_ARMOR", 30);

	M_MEDIC_INITIAL_HEALTH = vrx_lua_get_variable("M_MEDIC_INITIAL_HEALTH", 100);
	M_MEDIC_ADDON_HEALTH = vrx_lua_get_variable("M_MEDIC_ADDON_HEALTH", 10);
	M_MEDIC_INITIAL_ARMOR = vrx_lua_get_variable("M_MEDIC_INITIAL_ARMOR", 100);
	M_MEDIC_ADDON_ARMOR = vrx_lua_get_variable("M_MEDIC_ADDON_ARMOR", 20);

	M_MUTANT_INITIAL_HEALTH = vrx_lua_get_variable("M_MUTANT_INITIAL_HEALTH", 135);
	M_MUTANT_ADDON_HEALTH = vrx_lua_get_variable("M_MUTANT_ADDON_HEALTH", 75);
	M_MUTANT_INITIAL_ARMOR = vrx_lua_get_variable("M_MUTANT_INITIAL_ARMOR", 0);
	M_MUTANT_ADDON_ARMOR = vrx_lua_get_variable("M_MUTANT_ADDON_ARMOR", 0);
	M_REDMUTANT_INITIAL_HEALTH = vrx_lua_get_variable("M_REDMUTANT_INITIAL_HEALTH", 150);
	M_REDMUTANT_ADDON_HEALTH = vrx_lua_get_variable("M_REDMUTANT_ADDON_HEALTH", 85);
	M_REDMUTANT_INITIAL_ARMOR = vrx_lua_get_variable("M_REDMUTANT_INITIAL_ARMOR", 0);
	M_REDMUTANT_ADDON_ARMOR = vrx_lua_get_variable("M_REDMUTANT_ADDON_ARMOR", 0);

	M_PARASITE_INITIAL_HEALTH = vrx_lua_get_variable("M_PARASITE_INITIAL_HEALTH", 75);
	M_PARASITE_ADDON_HEALTH = vrx_lua_get_variable("M_PARASITE_ADDON_HEALTH", 30);
	M_PARASITE_INITIAL_ARMOR = vrx_lua_get_variable("M_PARASITE_INITIAL_ARMOR", 0);
	M_PARASITE_ADDON_ARMOR = vrx_lua_get_variable("M_PARASITE_ADDON_ARMOR", 0);

	M_TANK_INITIAL_HEALTH = vrx_lua_get_variable("M_TANK_INITIAL_HEALTH", 100);
	...
	M_CHICK_HEAT_INITIAL_HEALTH = vrx_lua_get_variable("M_CHICK_HEAT_INITIAL_HEALTH", 50);
	M_CHICK_HEAT_ADDON_HEALTH = vrx_lua_get_variable("M_CHICK_HEAT_ADDON_HEALTH", 15);
	M_CHICK_HEAT_INITIAL_ARMOR = vrx_lua_get_variable("M_CHICK_HEAT_INITIAL_ARMOR", 25);
	M_CHICK_HEAT_ADDON_ARMOR = vrx_lua_get_variable("M_CHICK_HEAT_ADDON_ARMOR", 15);
	M_DAEDALUS_INITIAL_HEALTH = vrx_lua_get_variable("M_DAEDALUS_INITIAL_HEALTH", 50);
	M_DAEDALUS_ADDON_HEALTH = vrx_lua_get_variable("M_DAEDALUS_ADDON_HEALTH", 20);
	M_DAEDALUS_INITIAL_ARMOR = vrx_lua_get_variable("M_DAEDALUS_INITIAL_ARMOR", 150);
	M_DAEDALUS_ADDON_ARMOR = vrx_lua_get_variable("M_DAEDALUS_ADDON_ARMOR", 60);
	M_RUNNERTANK_INITIAL_HEALTH = vrx_lua_get_variable("M_RUNNERTANK_INITIAL_HEALTH", 100);
	M_RUNNERTANK_ADDON_HEALTH = vrx_lua_get_variable("M_RUNNERTANK_ADDON_HEALTH", 65);
	M_RUNNERTANK_INITIAL_ARMOR = vrx_lua_get_variable("M_RUNNERTANK_INITIAL_ARMOR", 200);
	M_RUNNERTANK_ADDON_ARMOR = vrx_lua_get_variable("M_RUNNERTANK_ADDON_ARMOR", 105);
	M_GEKK_INITIAL_HEALTH = vrx_lua_get_variable("M_GEKK_INITIAL_HEALTH", 150);
	M_GEKK_ADDON_HEALTH = vrx_lua_get_variable("M_GEKK_ADDON_HEALTH", 85);
	M_GEKK_INITIAL_ARMOR = vrx_lua_get_variable("M_GEKK_INITIAL_ARMOR", 0);
	M_GEKK_ADDON_ARMOR = vrx_lua_get_variable("M_GEKK_ADDON_ARMOR", 0);
	M_STALKER_INITIAL_HEALTH = vrx_lua_get_variable("M_STALKER_INITIAL_HEALTH", 150);
	M_STALKER_ADDON_HEALTH = vrx_lua_get_variable("M_STALKER_ADDON_HEALTH", 85);
	M_STALKER_INITIAL_ARMOR = vrx_lua_get_variable("M_STALKER_INITIAL_ARMOR", 0);
	M_STALKER_ADDON_ARMOR = vrx_lua_get_variable("M_STALKER_ADDON_ARMOR", 0);
	M_MEDIC_COMMANDER_INITIAL_HEALTH = vrx_lua_get_variable("M_MEDIC_COMMANDER_INITIAL_HEALTH", 200);
	M_MEDIC_COMMANDER_ADDON_HEALTH = vrx_lua_get_variable("M_MEDIC_COMMANDER_ADDON_HEALTH", 20);
	M_MEDIC_COMMANDER_INITIAL_ARMOR = vrx_lua_get_variable("M_MEDIC_COMMANDER_INITIAL_ARMOR", 200);
	M_MEDIC_COMMANDER_ADDON_ARMOR = vrx_lua_get_variable("M_MEDIC_COMMANDER_ADDON_ARMOR", 40);
	M_GUNCMDR_INITIAL_HEALTH = vrx_lua_get_variable("M_GUNCMDR_INITIAL_HEALTH", 70);
	M_GUNCMDR_ADDON_HEALTH = vrx_lua_get_variable("M_GUNCMDR_ADDON_HEALTH", 45);
	M_GUNCMDR_INITIAL_ARMOR = vrx_lua_get_variable("M_GUNCMDR_INITIAL_ARMOR", 80);
	M_GUNCMDR_ADDON_ARMOR = vrx_lua_get_variable("M_GUNCMDR_ADDON_ARMOR", 25);
	M_GLADB_INITIAL_HEALTH = vrx_lua_get_variable("M_GLADB_INITIAL_HEALTH", 100);
	M_GLADB_ADDON_HEALTH = vrx_lua_get_variable("M_GLADB_ADDON_HEALTH", 10);
	M_GLADB_INITIAL_ARMOR = vrx_lua_get_variable("M_GLADB_INITIAL_ARMOR", 100);
	M_GLADB_ADDON_ARMOR = vrx_lua_get_variable("M_GLADB_ADDON_ARMOR", 20);
	M_GLADC_INITIAL_HEALTH = vrx_lua_get_variable("M_GLADC_INITIAL_HEALTH", 100);
	M_GLADC_ADDON_HEALTH = vrx_lua_get_variable("M_GLADC_ADDON_HEALTH", 10);
	...
	M_WIDOW_INITIAL_HEALTH = vrx_lua_get_variable("M_WIDOW_INITIAL_HEALTH", 2400);
	M_WIDOW_ADDON_HEALTH = vrx_lua_get_variable("M_WIDOW_ADDON_HEALTH", 700);
	M_WIDOW_INITIAL_ARMOR = vrx_lua_get_variable("M_WIDOW_INITIAL_ARMOR", 600);
	M_WIDOW_ADDON_ARMOR = vrx_lua_get_variable("M_WIDOW_ADDON_ARMOR", 350);
	M_WIDOW2_INITIAL_HEALTH = vrx_lua_get_variable("M_WIDOW2_INITIAL_HEALTH", 3000);
	M_WIDOW2_ADDON_HEALTH = vrx_lua_get_variable("M_WIDOW2_ADDON_HEALTH", 900);
	M_WIDOW2_INITIAL_ARMOR = vrx_lua_get_variable("M_WIDOW2_INITIAL_ARMOR", 750);
	M_WIDOW2_ADDON_ARMOR = vrx_lua_get_variable("M_WIDOW2_ADDON_ARMOR", 450);
	M_FIXBOT_INITIAL_HEALTH = vrx_lua_get_variable("M_FIXBOT_INITIAL_HEALTH", 250);
	M_FIXBOT_ADDON_HEALTH = vrx_lua_get_variable("M_FIXBOT_ADDON_HEALTH", 90);
	M_FIXBOT_INITIAL_ARMOR = vrx_lua_get_variable("M_FIXBOT_INITIAL_ARMOR", 120);
	M_FIXBOT_ADDON_ARMOR = vrx_lua_get_variable("M_FIXBOT_ADDON_ARMOR", 45);
	M_FIXBOT_BOSS_INITIAL_HEALTH = vrx_lua_get_variable("M_FIXBOT_BOSS_INITIAL_HEALTH", 3200);
	M_FIXBOT_BOSS_ADDON_HEALTH = vrx_lua_get_variable("M_FIXBOT_BOSS_ADDON_HEALTH", 850);
	M_FIXBOT_BOSS_INITIAL_ARMOR = vrx_lua_get_variable("M_FIXBOT_BOSS_INITIAL_ARMOR", 700);
	M_FIXBOT_BOSS_ADDON_ARMOR = vrx_lua_get_variable("M_FIXBOT_BOSS_ADDON_ARMOR", 350);
	M_ROGUE_TURRET_INITIAL_HEALTH = vrx_lua_get_variable("M_ROGUE_TURRET_INITIAL_HEALTH", 50);
	M_ROGUE_TURRET_ADDON_HEALTH = vrx_lua_get_variable("M_ROGUE_TURRET_ADDON_HEALTH", 25);
	M_ROGUE_TURRET_INITIAL_ARMOR = vrx_lua_get_variable("M_ROGUE_TURRET_INITIAL_ARMOR", 50);
	M_ROGUE_TURRET_ADDON_ARMOR = vrx_lua_get_variable("M_ROGUE_TURRET_ADDON_ARMOR", 15);
	M_BOSS2_INITIAL_HEALTH = vrx_lua_get_variable("M_BOSS2_INITIAL_HEALTH", 2400);
	M_BOSS2_ADDON_HEALTH = vrx_lua_get_variable("M_BOSS2_ADDON_HEALTH", 700);
	M_BOSS2_INITIAL_ARMOR = vrx_lua_get_variable("M_BOSS2_INITIAL_ARMOR", 600);
	M_BOSS2_ADDON_ARMOR = vrx_lua_get_variable("M_BOSS2_ADDON_ARMOR", 350);
	M_BOSS2_SMALL_INITIAL_HEALTH = vrx_lua_get_variable("M_BOSS2_SMALL_INITIAL_HEALTH", 250);
	M_BOSS2_SMALL_ADDON_HEALTH = vrx_lua_get_variable("M_BOSS2_SMALL_ADDON_HEALTH", 100);
	M_BOSS2_SMALL_INITIAL_ARMOR = vrx_lua_get_variable("M_BOSS2_SMALL_INITIAL_ARMOR", 160);
	M_BOSS2_SMALL_ADDON_ARMOR = vrx_lua_get_variable("M_BOSS2_SMALL_ADDON_ARMOR", 70);
	M_GUARDIAN_INITIAL_HEALTH = vrx_lua_get_variable("M_GUARDIAN_INITIAL_HEALTH", 6500);
	M_GUARDIAN_ADDON_HEALTH = vrx_lua_get_variable("M_GUARDIAN_ADDON_HEALTH", 1200);
	M_GUARDIAN_INITIAL_ARMOR = vrx_lua_get_variable("M_GUARDIAN_INITIAL_ARMOR", 550);
	M_GUARDIAN_ADDON_ARMOR = vrx_lua_get_variable("M_GUARDIAN_ADDON_ARMOR", 250);
	M_JANITOR_INITIAL_HEALTH = vrx_lua_get_variable("M_JANITOR_INITIAL_HEALTH", 125);
	M_JANITOR_ADDON_HEALTH = vrx_lua_get_variable("M_JANITOR_ADDON_HEALTH", 50);
	M_JANITOR_INITIAL_ARMOR = vrx_lua_get_variable("M_JANITOR_INITIAL_ARMOR", 300);
	M_JANITOR_ADDON_ARMOR = vrx_lua_get_variable("M_JANITOR_ADDON_ARMOR", 100);
	M_MINIGUARDIAN_INITIAL_HEALTH = vrx_lua_get_variable("M_MINIGUARDIAN_INITIAL_HEALTH", 400);
	M_MINIGUARDIAN_ADDON_HEALTH = vrx_lua_get_variable("M_MINIGUARDIAN_ADDON_HEALTH", 100);
	M_MINIGUARDIAN_INITIAL_ARMOR = vrx_lua_get_variable("M_MINIGUARDIAN_INITIAL_ARMOR", 450);
	M_MINIGUARDIAN_ADDON_ARMOR = vrx_lua_get_variable("M_MINIGUARDIAN_ADDON_ARMOR", 150);
	M_SOLDIER_RIPPER_INITIAL_HEALTH = vrx_lua_get_variable("M_SOLDIER_RIPPER_INITIAL_HEALTH", 100);
	M_SOLDIER_RIPPER_ADDON_HEALTH = vrx_lua_get_variable("M_SOLDIER_RIPPER_ADDON_HEALTH", 40);
	M_SOLDIER_RIPPER_INITIAL_ARMOR = vrx_lua_get_variable("M_SOLDIER_RIPPER_INITIAL_ARMOR", 50);
	M_SOLDIER_RIPPER_ADDON_ARMOR = vrx_lua_get_variable("M_SOLDIER_RIPPER_ADDON_ARMOR", 20);
	M_SOLDIER_BLUEBLASTER_INITIAL_HEALTH = vrx_lua_get_variable("M_SOLDIER_BLUEBLASTER_INITIAL_HEALTH", 100);
	M_SOLDIER_BLUEBLASTER_ADDON_HEALTH = vrx_lua_get_variable("M_SOLDIER_BLUEBLASTER_ADDON_HEALTH", 40);
	M_SOLDIER_BLUEBLASTER_INITIAL_ARMOR = vrx_lua_get_variable("M_SOLDIER_BLUEBLASTER_INITIAL_ARMOR", 50);
	M_SOLDIER_BLUEBLASTER_ADDON_ARMOR = vrx_lua_get_variable("M_SOLDIER_BLUEBLASTER_ADDON_ARMOR", 20);
	M_SOLDIER_LASER_INITIAL_HEALTH = vrx_lua_get_variable("M_SOLDIER_LASER_INITIAL_HEALTH", 120);
	M_SOLDIER_LASER_ADDON_HEALTH = vrx_lua_get_variable("M_SOLDIER_LASER_ADDON_HEALTH", 45);
	M_SOLDIER_LASER_INITIAL_ARMOR = vrx_lua_get_variable("M_SOLDIER_LASER_INITIAL_ARMOR", 70);
	M_SOLDIER_LASER_ADDON_ARMOR = vrx_lua_get_variable("M_SOLDIER_LASER_ADDON_ARMOR", 25);
	...
	M_BRAIN_MAX_PULL = vrx_lua_get_variable("M_BRAIN_MAX_PULL", -100);
	M_BRAIN_INITIAL_TENTACLE_DMG = vrx_lua_get_variable("M_BRAIN_INITIAL_TENTACLE_DMG", 30);
	M_BRAIN_ADDON_TENTACLE_DMG = vrx_lua_get_variable("M_BRAIN_ADDON_TENTACLE_DMG", 6);
	M_BRAIN_MAX_TENTACLE_DMG = vrx_lua_get_variable("M_BRAIN_MAX_TENTACLE_DMG", 0);

	M_ENABLE_WORLDSPAWN_SOFTCAP = vrx_lua_get_variable("M_ENABLE_WORLDSPAWN_SOFTCAP", 1);

	M_GRENADELAUNCHER_DMG_BASE = vrx_lua_get_variable("M_GRENADELAUNCHER_DMG_BASE", 50);
	M_GRENADELAUNCHER_DMG_ADDON = vrx_lua_get_variable("M_GRENADELAUNCHER_DMG_ADDON", 10);
	M_GRENADELAUNCHER_DMG_MAX = vrx_lua_get_variable("M_GRENADELAUNCHER_DMG_MAX", 0);
	M_GRENADELAUNCHER_SPEED_BASE = vrx_lua_get_variable("M_GRENADELAUNCHER_SPEED_BASE", 600);
	M_GRENADELAUNCHER_SPEED_ADDON = vrx_lua_get_variable("M_GRENADELAUNCHER_SPEED_ADDON", 30);
	M_GRENADELAUNCHER_SPEED_MAX = vrx_lua_get_variable("M_GRENADELAUNCHER_SPEED_MAX", 1100);

	M_ROCKETLAUNCHER_DMG_BASE = vrx_lua_get_variable("M_ROCKETLAUNCHER_DMG_BASE", 50);
	M_ROCKETLAUNCHER_DMG_ADDON = vrx_lua_get_variable("M_ROCKETLAUNCHER_DMG_ADDON", 10);
	M_ROCKETLAUNCHER_DMG_MAX = vrx_lua_get_variable("M_ROCKETLAUNCHER_DMG_MAX", 0);
	M_ROCKETLAUNCHER_SPEED_BASE = vrx_lua_get_variable("M_ROCKETLAUNCHER_SPEED_BASE", 650);
	M_ROCKETLAUNCHER_SPEED_ADDON = vrx_lua_get_variable("M_ROCKETLAUNCHER_SPEED_ADDON", 30);
	M_ROCKETLAUNCHER_SPEED_MAX = vrx_lua_get_variable("M_ROCKETLAUNCHER_SPEED_MAX", 950);

	M_SHOTGUN_DMG_BASE = vrx_lua_get_variable("M_SHOTGUN_DMG_BASE", 5);
	M_SHOTGUN_DMG_ADDON = vrx_lua_get_variable("M_SHOTGUN_DMG_ADDON", 1);
	M_SHOTGUN_DMG_MAX = vrx_lua_get_variable("M_SHOTGUN_DMG_MAX", 0);

	M_RAILGUN_DMG_BASE = vrx_lua_get_variable("M_RAILGUN_DMG_BASE", 50);
	...
	M_HYPERBLASTER_DMG_MAX = vrx_lua_get_variable("M_HYPERBLASTER_DMG_MAX", 0);

	M_MACHINEGUN_DMG_BASE = vrx_lua_get_variable("M_MACHINEGUN_DMG_BASE", 10);
	M_MACHINEGUN_DMG_ADDON = vrx_lua_get_variable("M_MACHINEGUN_DMG_ADDON", 1);
	M_MACHINEGUN_DMG_MAX = vrx_lua_get_variable("M_MACHINEGUN_DMG_MAX", 0);

	M_BLASTER_DMG_BASE = vrx_lua_get_variable("M_BLASTER_DMG_BASE", 50);
	M_BLASTER_DMG_ADDON = vrx_lua_get_variable("M_BLASTER_DMG_ADDON", 10);
	M_BLASTER_DMG_MAX = vrx_lua_get_variable("M_BLASTER_DMG_MAX", 0);
	M_BLASTER_SPEED_BASE = vrx_lua_get_variable("M_BLASTER_SPEED_BASE", 1000);
	...
	M_BLASTER2_SPEED_BASE = vrx_lua_get_variable("M_BLASTER2_SPEED_BASE", 1150);
	...
	M_20MM_RANGE_BASE = vrx_lua_get_variable("M_20MM_RANGE_BASE", 750);
	M_20MM_RANGE_ADDON = vrx_lua_get_variable("M_20MM_RANGE_ADDON", 0);
	M_20MM_RANGE_MAX = vrx_lua_get_variable("M_20MM_RANGE_MAX", 750);
	...
	MEDIC_RESURRECT_BONUS = vrx_lua_get_variable("MEDIC_RESURRECT_BONUS", 0.05);
	MEDIC_RESURRECT_BASE = vrx_lua_get_variable("MEDIC_RESURRECT_BASE", 1.0);
	MEDIC_RESURRECT_INITIAL_TIME = vrx_lua_get_variable("MEDIC_RESURRECT_INITIAL_TIME", 30.0);
	MEDIC_RESURRECT_ADDON_TIME = vrx_lua_get_variable("MEDIC_RESURRECT_ADDON_TIME", 7.5);
	MEDIC_RESURRECT_TIMEOUT = vrx_lua_get_variable("MEDIC_RESURRECT_TIMEOUT", 180.0);
	...
	PARASITE_ATTACK_RANGE = vrx_lua_get_int("PARASITE_ATTACK_RANGE", 96);
	PARASITE_INITIAL_KNOCKBACK = vrx_lua_get_int("PARASITE_INITIAL_KNOCKBACK", -60);
	PARASITE_ADDON_KNOCKBACK = vrx_lua_get_int("PARASITE_ADDON_KNOCKBACK", -2);
	PARASITE_MAX_KNOCKBACK = vrx_lua_get_int("PARASITE_MAX_KNOCKBACK", -80);
	PARASITE_INITIAL_DMG = vrx_lua_get_int("PARASITE_INITIAL_DMG", 10);
	PARASITE_ADDON_DMG = vrx_lua_get_int("PARASITE_ADDON_DMG", 1);
	PARASITE_MAX_DMG = vrx_lua_get_int("PARASITE_MAX_DMG", 0);
	...
	BLINKSTRIKE_DELAY = vrx_lua_get_variable("BLINKSTRIKE_DELAY", 1.0);
	BLINKSTRIKE_FRAMES = vrx_lua_get_variable("BLINKSTRIKE_FRAMES", 50);
	BLINKSTRIKE_INITIAL_BONUS = vrx_lua_get_variable("BLINKSTRIKE_INITIAL_BONUS", 0);
	BLINKSTRIKE_ADDON_BONUS = vrx_lua_get_variable("BLINKSTRIKE_ADDON_BONUS", 0.1);

	EXPLODING_BARREL_INITIAL_HEALTH = vrx_lua_get_variable("EXPLODING_BARREL_INITIAL_HEALTH", 50);
	EXPLODING_BARREL_ADDON_HEALTH = vrx_lua_get_variable("EXPLODING_BARREL_ADDON_HEALTH", 10);
	EXPLODING_BARREL_INITIAL_DAMAGE = vrx_lua_get_variable("EXPLODING_BARREL_INITIAL_DAMAGE", 50);
	EXPLODING_BARREL_ADDON_DAMAGE = vrx_lua_get_variable("EXPLODING_BARREL_ADDON_DAMAGE", 35);
	EXPLODING_BARREL_COST = vrx_lua_get_variable("EXPLODING_BARREL_COST", 20);
	EXPLODING_BARREL_DELAY = vrx_lua_get_variable("EXPLODING_BARREL_DELAY", 1.0);
	EXPLODING_BARREL_MAX_COUNT = vrx_lua_get_variable("EXPLODING_BARREL_MAX_COUNT", 4);

	ACID_GASSER_SYNERGY_BONUS = vrx_lua_get_variable("ACID_GASSER_SYNERGY_BONUS", 0.05);
	SPIKE_SPIKER_SYNERGY_BONUS = vrx_lua_get_variable("SPIKE_SPIKER_SYNERGY_BONUS", 0.05);

	FIREWALL_RANGE = vrx_lua_get_variable("FIREWALL_RANGE", 8192);
	FIREWALL_INITIAL_DAMAGE = vrx_lua_get_variable("FIREWALL_INITIAL_DAMAGE", 0);
	FIREWALL_ADDON_DAMAGE = vrx_lua_get_variable("FIREWALL_ADDON_DAMAGE", 50);
	...
	FROZEN_ORB_SPEED = vrx_lua_get_variable("FROZEN_ORB_SPEED", 200);
	FROZEN_ORB_DURATION = vrx_lua_get_variable("FROZEN_ORB_DURATION", 3.0);
	FROZEN_ORB_DELAY = vrx_lua_get_variable("FROZEN_ORB_DELAY", 1.0);
	FROZEN_ORB_COST = vrx_lua_get_variable("FROZEN_ORB_COST", 20);
	FROZEN_ORB_INITIAL_DAMAGE = vrx_lua_get_variable("FROZEN_ORB_INITIAL_DAMAGE", 50);
	FROZEN_ORB_ADDON_DAMAGE = vrx_lua_get_variable("FROZEN_ORB_ADDON_DAMAGE", 25);
	FROZEN_ORB_INITIAL_CHILL = vrx_lua_get_variable("FROZEN_ORB_INITIAL_CHILL", 0);
	FROZEN_ORB_ADDON_CHILL = vrx_lua_get_variable("FROZEN_ORB_ADDON_CHILL", 0.5);

	FROST_NOVA_COST = vrx_lua_get_variable("FROST_NOVA_COST", 20);
	FROST_NOVA_INITIAL_DAMAGE = vrx_lua_get_variable("FROST_NOVA_INITIAL_DAMAGE", 50);
	FROST_NOVA_ADDON_DAMAGE = vrx_lua_get_variable("FROST_NOVA_ADDON_DAMAGE", 25);
	FROST_NOVA_INITIAL_RADIUS = vrx_lua_get_variable("FROST_NOVA_INITIAL_RADIUS", 100);
	FROST_NOVA_ADDON_RADIUS = vrx_lua_get_variable("FROST_NOVA_ADDON_RADIUS", 10);
	FROST_NOVA_DELAY = vrx_lua_get_variable("FROST_NOVA_DELAY", 0.3);
	FROST_NOVA_INITIAL_CHILL = vrx_lua_get_variable("FROST_NOVA_INITIAL_CHILL", 0);
	FROST_NOVA_ADDON_CHILL = vrx_lua_get_variable("FROST_NOVA_ADDON_CHILL", 0.5);

	GLACIAL_SPIKE_COST = vrx_lua_get_variable("GLACIAL_SPIKE_COST", 20);
	GLACIAL_SPIKE_INITIAL_CHILL = vrx_lua_get_variable("GLACIAL_SPIKE_INITIAL_CHILL", 0);
	GLACIAL_SPIKE_ADDON_CHILL = vrx_lua_get_variable("GLACIAL_SPIKE_ADDON_CHILL", 0.5);
	GLACIAL_SPIKE_INITIAL_FREEZE = vrx_lua_get_variable("GLACIAL_SPIKE_INITIAL_FREEZE", 0);
	GLACIAL_SPIKE_ADDON_FREEZE = vrx_lua_get_variable("GLACIAL_SPIKE_ADDON_FREEZE", 0.2);
	GLACIAL_SPIKE_INITIAL_DAMAGE = vrx_lua_get_variable("GLACIAL_SPIKE_INITIAL_DAMAGE", 50);
	GLACIAL_SPIKE_ADDON_DAMAGE = vrx_lua_get_variable("GLACIAL_SPIKE_ADDON_DAMAGE", 25);
	GLACIAL_SPIKE_INITIAL_RADIUS = vrx_lua_get_variable("GLACIAL_SPIKE_INITIAL_RADIUS", 100);
	GLACIAL_SPIKE_ADDON_RADIUS = vrx_lua_get_variable("GLACIAL_SPIKE_ADDON_RADIUS", 5);
	GLACIAL_SPIKE_INITIAL_SPEED = vrx_lua_get_variable("GLACIAL_SPIKE_INITIAL_SPEED", 500);
	GLACIAL_SPIKE_ADDON_SPEED = vrx_lua_get_variable("GLACIAL_SPIKE_ADDON_SPEED", 0);
	GLACIAL_SPIKE_DELAY = vrx_lua_get_variable("GLACIAL_SPIKE_DELAY", 0.3);
