...
#pragma endregion /*Weapons Parameters*/
	...
	M_GUNCMDR_INITIAL_HEALTH = vrx_lua_get_variable("M_GUNCMDR_INITIAL_HEALTH", 100);
	M_GUNCMDR_ADDON_HEALTH = vrx_lua_get_variable("M_GUNCMDR_ADDON_HEALTH", 65);
	M_GUNCMDR_INITIAL_ARMOR = vrx_lua_get_variable("M_GUNCMDR_INITIAL_ARMOR", 200);
	M_GUNCMDR_ADDON_ARMOR = vrx_lua_get_variable("M_GUNCMDR_ADDON_ARMOR", 105);
	...
	M_GRENADELAUNCHER_SPEED_MAX = vrx_lua_get_variable("M_GRENADELAUNCHER_SPEED_MAX", 900);
