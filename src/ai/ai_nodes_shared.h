...
#define AI_MOD_FOLDER		game_dir->string
#define AI_NODES_FOLDER		"settings/navi"

#define MASK_NODESOLID		(CONTENTS_SOLID|CONTENTS_PLAYERCLIP/*|CONTENTS_MONSTERCLIP*/|CONTENTS_WINDOW)//GHz: removed monsterclip so certain maps don't break nodes
...
#define AI_JUMPABLE_HEIGHT		48 //GHz changed from 34
