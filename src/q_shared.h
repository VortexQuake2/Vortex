...
enum contents_t : uint32_t {
    ...
    CONTENTS_NO_WATERJUMP = U32BIT(13),
    CONTENTS_PROJECTILECLIP = U32BIT(14),
    CONTENTS_AREAPROTAL = U32BIT(15),
    CONTENTS_PLAYERCLIP = U32BIT(16),
    CONTENTS_MONSTERCLIP = U32BIT(17),

    CONTENTS_CURRENT_0 = U32BIT(18),
    CONTENTS_CURRENT_90 = U32BIT(19),
    CONTENTS_CURRENT_180 = U32BIT(20),
    CONTENTS_CURRENT_270 = U32BIT(21),
    CONTENT_CURRENTS_UP = U32BIT(22),
    CONTENT_CURRENTS_DOWN = U32BIT(23),

    CONTENTS_ORIGIN = U32BIT(24), // removed before bsping an entity

    CONTENTS_MONSTER = U32BIT(25),
    CONTENTS_DEADMONSTER = U32BIT(26),
    CONTENTS_DETAIL = U32BIT(27),
    CONTENTS_TRANSLUCENT = U32BIT(28),
    CONTENTS_LADDER = U32BIT(29),
#ifdef VRX_REPRO
    CONTENTS_PLAYER = U32BIT(30),
    CONTENTS_PROJECTILE = U32BIT(31)
#endif
};
...
#ifdef VRX_REPRO
    CS_SHADOWLIGHTS = CS_LIGHTS + MAX_LIGHTSTYLES,
