...
/*QUAKED weapon_old_supershotgun (.3 .3 1) (-16 -16 -16) (16 16 16)	8
                 */
                {
                    "weapon_old_supershotgun",
                    Pickup_Weapon,
                    Use_Weapon,
                    Drop_Weapon,
                    Weapon_OldSuperShotgun,
                    "misc/w_pkup.wav",
                    "models/weapons/lq1/g_shot.md2", EF_ROTATE,
                    "models/weapons/lq1/v_shot2.md2",
                    /* icon */        "w_sshotgun",
                    /* pickup */    "Old Super Shotgun",
                    0,
                    2,
                    "Shells",
                    IT_WEAPON,
