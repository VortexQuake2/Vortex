...
#define MAX_SIDEBAR_LAYOUT 1024
#define SIDEBAR_MAX_CONFIGSTRINGS (MAX_SIDEBAR_LAYOUT / CS_MAX_STRING_LENGTH)
enum
{
	// az: reserved for vortex
	CONFIG_CHASE = CS_GENERAL + 1,
	CONFIG_SIDEBAR = CONFIG_CHASE + 1, // 11 * 96 = 1056 (sidebar layout string)
	CONFIG_CTF_MATCH = CONFIG_SIDEBAR + SIDEBAR_MAX_CONFIGSTRINGS,
	CONFIG_CTF_TEAMINFO,
